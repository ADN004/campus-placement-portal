        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-12 border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 border-2 border-amber-100">
              <h2 className="text-2xl font-bold bg-gradient-to-r from-amber-700 to-orange-700 bg-clip-text text-transparent mb-4 flex items-center gap-2">
                <span className="bg-gradient-to-br from-amber-500 to-orange-600 text-white rounded-lg px-3 py-1 text-sm">4</span>
                Academic Information
              </h2>

              <div className="mb-5 flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-xl px-4 py-3">
                ...
                <p className="text-sm text-blue-800">
                  Don't remember your semester SGPA?{' '}
                  <a
                    href="https://polygpa.in/"
                    target="_blank"
                  ...
                  — your filled data will be safe when you return.
                </p>
              </div>
