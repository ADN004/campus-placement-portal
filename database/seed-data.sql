...
-- 3. SUPER ADMIN USER
-- ============================================
-- NOTE: Super admin is NO LONGER created here.
-- It is created interactively during seeding via seedDatabase.js
-- This ensures only authorized personnel can create super admin accounts.
-- See backend/scripts/seedDatabase.js for the interactive setup process.
