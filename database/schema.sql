...
CREATE TABLE students (
    ...
    branch VARCHAR(100),
    programme_cgpa DECIMAL(4,2) NOT NULL CHECK (programme_cgpa >= 0 AND programme_cgpa <= 10),
    cgpa_sem1 DECIMAL(4,2) CHECK (cgpa_sem1 >= 0 AND cgpa_sem1 <= 10),
    cgpa_sem2 DECIMAL(4,2) CHECK (cgpa_sem2 >= 0 AND cgpa_sem2 <= 10),
    cgpa_sem3 DECIMAL(4,2) CHECK (cgpa_sem3 >= 0 AND cgpa_sem3 <= 10),
    cgpa_sem4 DECIMAL(4,2) CHECK (cgpa_sem4 >= 0 AND cgpa_sem4 <= 10),
    cgpa_sem5 DECIMAL(4,2) DEFAULT 0 CHECK (cgpa_sem5 >= 0 AND cgpa_sem5 <= 10),
    cgpa_sem6 DECIMAL(4,2) DEFAULT 0 CHECK (cgpa_sem6 >= 0 AND cgpa_sem6 <= 10),
