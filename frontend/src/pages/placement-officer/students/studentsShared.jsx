...
/*
 * Moved to components/officer/Pagination so the applicant tables could use the
 * same pager. Re-exported here so these presenters keep importing from one
 * place, exactly as before.
 */
export { default as Pagination } from '../../../components/officer/Pagination';
