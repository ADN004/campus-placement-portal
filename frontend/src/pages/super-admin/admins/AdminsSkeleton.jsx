/** The super-admin list before it arrives. */
export default function AdminsSkeleton({ layout = 'desktop' }) {
  ...
  return (
    <div aria-busy="true" aria-live="polite">
      <span className="sr-only">Loading super admins</span>
      ...
      <div className="bg-spc-surface border border-spc-line-strong rounded-spc-admin overflow-hidden">
        ...
        {Array.from({ length: 3 }, (_, i) => (
          <div key={i} className="flex items-center justify-between gap-4 px-4 py-3.5
            ...
            <Block className="h-11 w-32 flex-shrink-0" />
          </div>
        ))}
      </div>
    </div>
