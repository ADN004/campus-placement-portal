...
export const studentAPI = {
  ...
  getCorrectionStatus: () => API.get('/students/correction-status'),
  reuploadPhoto: (photoBase64) => API.post('/students/photo', { photo_base64: photoBase64 }),
  resolveCorrection: () => API.post('/students/correction/resolve'),
...
export const superAdminAPI = {
  ...
  requestStudentCorrection: (studentId, note, requirePhoto) => API.post(`/super-admin/students/${studentId}/request-correction`, { note, require_photo: requirePhoto }),
