  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mb-10">
        ...
        <div className="bg-white/60 rounded-2xl border border-gray-200/50 overflow-hidden">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="p-4 flex items-start gap-4 border-b border-gray-100 last:border-0">
              <div className="h-10 w-10 bg-gray-200/70 rounded-full animate-pulse flex-shrink-0" />
              <div className="flex-1">
                <div className="h-5 w-48 bg-gray-200/70 rounded-lg animate-pulse mb-2" />
      ...
      <div className="mb-10">
        <div className="flex items-center gap-4 mb-6">
          <div className="h-12 w-12 bg-gray-200/70 rounded-2xl animate-pulse" />
          <div className="h-8 w-52 bg-gray-200/70 rounded-lg animate-pulse" />
        </div>
        <div className="bg-white/60 rounded-2xl border border-gray-200/50 p-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="bg-white rounded-2xl border border-gray-200 p-6">
                <div className="h-5 w-32 bg-gray-200/70 rounded-full animate-pulse mb-3" />
                <div className="h-10 w-12 bg-gray-200/70 rounded-lg animate-pulse mb-1" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[...Array(2)].map((_, i) => (
              <div key={i} className="bg-white rounded-2xl border border-gray-200 p-6">
                <div className="h-5 w-40 bg-gray-200/70 rounded-full animate-pulse mb-3" />
                <div className="h-10 w-12 bg-gray-200/70 rounded-lg animate-pulse mb-1" />
                <div className="h-4 w-16 bg-gray-200/50 rounded animate-pulse" />
              </div>
            ))}
